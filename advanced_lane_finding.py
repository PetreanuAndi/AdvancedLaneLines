...
def main():
	...
	# read image
    path_to_img = PATH_TO_TEST_IMG + 'test6.jpg'
    ...
    threshOut[(hls_binary==255)|(combined_binary==255)] = 255

    # Birds Eye View
    warped = get_warped_image(threshOut)

    lane_img,ploty,left_fitx,right_fitx = findLaneLines(warped)
    ...
    if (DISPLAY):
    	...
    	#cv2.imshow('4.Threshold Output',threshOut)
